...
const ResturentCard = (props) => {
  const { resData } = props;
  const { cloudinaryImageId, name, cuisines, costForTwo, slaString } =
    resData?.data;
  return (
      ...
      <div className="res-container">
        {resObj.map((restaurant)=>(
            <ResturentCard key={restaurant.data.id} resData={restaurant}/>
                 ...
                 {/*                 
                <ResturentCard resData={resObj[0]}/>
                <ResturentCard resData={resObj[1]}/>
                <ResturentCard resData={resObj[2]}/>
                <ResturentCard resData={resObj[3]}/> */}
